...
export default {
    ...
    async handler(sock, message, args, context) {
        ...
        try {
            ...
            let menuText = `${menuEmoji} *${config.botName || 'YOUSAF-MD'}* ${menuEmoji}\n\n`;
            menuText += `┏━━━━━━━━━━━━━━━━┓\n`;
            menuText += `┃ 📱 *Bot:* ${config.botName || 'YOUSAF-MD'}\n`;
            ...
            menuText += `┗━━━━━━━━━━━━━━━━┛\n\n`;
            menuText += `🔗 *CONNECT WITH US*\n`;
            menuText += `┌─────────────────\n`;
            menuText += `│ 📢 Channel: ${config.channelLink || ''}\n`;
            menuText += `│ 🎥 YouTube: ${config.youtubeLink || ''}\n`;
            menuText += `│ 🎵 TikTok: ${config.tiktokLink || ''}\n`;
            menuText += `│ 💻 GitHub: ${config.githubLink || ''}\n`;
            menuText += `└─────────────────\n\n`;
