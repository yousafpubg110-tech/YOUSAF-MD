    ...
    try {
        ...
        if (viewOnceContainer) {
            if (viewOnceContainer.imageMessage) {
                ...
                if (viewOnceContainer.imageMessage.mediaKey && viewOnceContainer.imageMessage.mediaKey.length) {
                ...
                if (viewOnceContainer.videoMessage.mediaKey && viewOnceContainer.videoMessage.mediaKey.length) {
            ...
            if (message.message.imageMessage.mediaKey && message.message.imageMessage.mediaKey.length) {
            ...
            mediaType = 'sticker';
            if (message.message.stickerMessage.mediaKey && message.message.stickerMessage.mediaKey.length) {
            ...
            if (message.message.videoMessage.mediaKey && message.message.videoMessage.mediaKey.length) {
            ...
            if (message.message.audioMessage.mediaKey && message.message.audioMessage.mediaKey.length) {
        ...
        console.error('storeMessage error:', err.message || err);
    }
}
