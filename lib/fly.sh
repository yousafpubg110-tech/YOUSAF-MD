#!/bin/bash
# YOUSAF-MD Fly.io One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/yousafpubg110-tech/YOUSAF-MD/main/lib/fly.sh)
...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════╗"
echo "║        YOUSAF-MD Fly.io Deployer        ║"
