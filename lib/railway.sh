#!/bin/bash
# YOUSAF-MD Railway One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/yousafpubg110-tech/YOUSAF-MD/main/lib/railway.sh)
...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════╗"
echo "║       YOUSAF-MD Railway Deployer        ║"
...
railway init --name "yousaf-md-bot"
