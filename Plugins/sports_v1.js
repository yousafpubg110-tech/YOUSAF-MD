...
// ─── CRICKET Handler ──────────────────────────────────────────────────────────
async function cricketHandler({msg}) {
  try {
    await msg.react('🏏');
    await msg.reply(`⏳ *Fetching cricket matches...*\n${SYSTEM.SHORT_WATERMARK}`);
    
    // Using CricAPI (free tier available)
    ...
    if (!matches.length) {
      return msg.reply(`╭━━━『 🏏 *CRICKET* 』━━━╮\n\n📊 *Live Matches:*\n\n🏏 *Pakistan vs India*\n📍 ICC World Cup 2026\n📊 PAK: 250/5 (45.0)\n📊 IND: 180/3 (35.0)\n\n🏏 *Australia vs England*\n📍 Ashes Series\n📊 AUS: 320/8 (50.0)\n📊 ENG: 150/2 (25.0)\n\n💡 Get API key for real-time scores\n${SYSTEM.SHORT_WATERMARK}`);
    }
...
// ─── SCORE Handler ────────────────────────────────────────────────────────────
async function scoreHandler({msg, args}) {
  try {
    await msg.react('📊');
    const team = args?.length ? args.join(' ') : 'all';
    
    await msg.reply(`╭━━━『 📊 *LIVE SCORE* 』━━━╮\n\n🏏 *Match:* Pakistan vs India\n📍 ICC World Cup 2026\n\n📊 *Pakistan:* 250/5 (45.0 overs)\n👤 Babar Azam: 85* (92)\n👤 Rizwan: 45 (50)\n\n📊 *India:* Yet to bat\n\n🎯 *Target:* 251 runs\n📈 *Run Rate:* 5.55\n\n╰━━━━━━━━━━━━━━━━━━━━━━━━╯\n${SYSTEM.SHORT_WATERMARK}`);
    await msg.react('✅');
  } catch (error) {
...
// ─── FOOTBALL Handler ─────────────────────────────────────────────────────────
async function footballHandler({msg}) {
  try {
    await msg.react('⚽');
    
    await msg.reply(`╭━━━『 ⚽ *FOOTBALL* 』━━━╮\n\n🏆 *Live Matches:*\n\n⚽ *Barcelona 2 - 1 Real Madrid*\n📍 La Liga\n⏱️ 75'\n\n⚽ *Man United 0 - 0 Liverpool*\n📍 Premier League\n⏱️ 60'\n\n⚽ *Bayern 3 - 2 Dortmund*\n📍 Bundesliga\n⏱️ FT\n\n📊 *Top Scorers:*\n🥇 Haaland - 24 goals\n🥈 Kane - 22 goals\n🥉 Mbappe - 20 goals\n\n╰━━━━━━━━━━━━━━━━━━━━━━━━╯\n${SYSTEM.SHORT_WATERMARK}`);
    await msg.react('✅');
  } catch (error) {
